...
theme.titlebar_bg_focus = x.color8
theme.titlebar_bg_normal = x.color0
theme.titlebar_fg_focus = x.color10
theme.titlebar_fg_normal = x.background .. "FF"
